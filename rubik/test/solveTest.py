...
class SolveTest(unittest.TestCase):  
    ...
    def test_011_ShouldRotateValidNominalCube_Ff(self):
        ...
        expectedResult = {}
        expectedResult['cube'] = 'rrgbbbbbboyyrrrrrrbyyggggggooyoooooobgryybgyywwwwwwwww'
        expectedResult['status'] = 'ok'
        actualResult = solve._solve(inputDict)
        self.assertEqual(expectedResult.get('cube'), actualResult.get('cube'))
        self.assertEqual(expectedResult.get('status'), actualResult.get('status'))
        
    def test_012_ShouldRotateValidNominalCube_FfB(self):

        inputDict = {}
        inputDict['cube'] = 'rrbbbbgggryyyyoroyogryggobbwwwwwwwwwgrboorbbyoyyrrgoog'
        inputDict['rotate'] = 'FfB'
        inputDict['op'] = 'solve'           
...
# Sad path tests
    ...
    def test_940_IncorrectParmsRotateString(self):
        ...
        expectedResult = {}
        expectedResult['status'] = 'error: optional rotate should be in [FfRrBbLlUuDd] or ""'
        actualResult = solve._solve(inputDict)
        self.assertEqual(expectedResult.get('status'), actualResult.get('status'))
