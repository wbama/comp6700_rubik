...
class SolveWhiteCrossTest(unittest.TestCase):                 
        ...
        def test_020_SolveWhiteCross_y1(self):
            inputDict = {}
            inputDict['cube'] = 'gywwgyyrwboygygrrbrwywbyyowgoorwobroobgbrywbobwgbogrgr'    
            expectedResult = 'w'             
        ...
        def test_040_SolveWhiteCross_y3(self):
            inputDict = {}
            inputDict['cube'] = 'rwywbyyowgoorwobrogywwgyyrwboygygrrbobwyrbgborgrgobgwb'    
            expectedResult = 'w'             
        ...
        def test_050_SolveWhiteCross_y4(self):
            inputDict = {}
            inputDict['cube'] = 'orgyowbogwgwbbyrgbgoborwyygyrbrgbyywowrbywwgorbygwoorr'    
            expectedResult = 'w'             
        ...
        def test_060_SolveWhiteCross_y5(self):
            inputDict = {}
            inputDict['cube'] = 'yygoryrbyooorbyrgogorboobbwggbggyrrbywwrwbogywwbwywgrw'    
            expectedResult = 'w'             
