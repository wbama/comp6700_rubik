...
class SolveLowerLayerTest(unittest.TestCase):  
    ...
    def test_030_RotateIntoTShape(self):   
        ...
        actualResult = solveMiddleLayer(inputDict)[0]
        #sides should also be solved
        self.assertEqual(actualResult[0][1], actualResult[0][4], actualResult[0][6]) or
        self.assertEqual(actualResult[1][1], actualResult[1][4], actualResult[1][6]) or
        self.assertEqual(actualResult[2][1], actualResult[2][4], actualResult[2][6]) or
