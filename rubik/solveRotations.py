...
def rotateSide_B_front(new_cube, orig_cube):
    new_cube[0].insert(0, orig_cube [0][0])
    new_cube[0].insert(1, orig_cube [0][1])
...
def rotateSide_B_Bight(new_cube, orig_cube):
...
def rotateSide_B_back(new_cube, orig_cube):   
...
def rotateSide_B_left(new_cube, orig_cube):  
...
def rotateSide_B_top(new_cube, orig_cube): 
...
def rotateSide_B_bottom(new_cube, orig_cube):      
    new_cube[5].insert(0, orig_cube [5][0])
    new_cube[5].insert(1, orig_cube [5][1])
...
def rotateSide_B(orig_cube): #rotates clock
    new_cube = [[], [], [], [], [], []]
    #front
    rotateSide_B_front(new_cube, orig_cube)       
    rotateSide_B_Bight(new_cube, orig_cube)        
    rotateSide_B_back(new_cube, orig_cube)          
    rotateSide_B_left(new_cube, orig_cube)         
    rotateSide_B_top(new_cube, orig_cube)        
    rotateSide_B_bottom(new_cube, orig_cube)  
...
def rotateSide_b_right(new_cube, orig_cube):
    new_cube[1].insert(0, orig_cube [1][0])
    new_cube[1].insert(1, orig_cube [1][1])
...
def rotateSide_b(orig_cube): 
    new_cube = [[], [], [], [], [], []]
    rotateSide_b_front(new_cube, orig_cube)
    rotateSide_b_right(new_cube, orig_cube)    
    rotateSide_b_back(new_cube, orig_cube)           
    rotateSide_b_left(new_cube, orig_cube)         
    rotateSide_b_top(new_cube, orig_cube)          
    rotateSide_b_bottom(new_cube, orig_cube)     
...
def rotateSide_L_front(new_cube, orig_cube):
...
def rotateSide_L_right(new_cube, orig_cube):
    new_cube[1].insert(0, orig_cube [1][0])
    new_cube[1].insert(1, orig_cube [1][1])
    new_cube[1].insert(2, orig_cube [1][2])
    new_cube[1].insert(3, orig_cube [1][3])
...
def rotateSide_L_back(new_cube, orig_cube):
    new_cube[2].insert(0, orig_cube [2][0])
    new_cube[2].insert(1, orig_cube [2][1])
...
def rotateSide_L_left(new_cube, orig_cube):
...
def rotateSide_L_top(new_cube, orig_cube):
...
def rotateSide_L_bottom(new_cube, orig_cube):
...
def rotateSide_L(orig_cube):
    new_cube = [[], [], [], [], [], []]
    #front
    rotateSide_L_front(new_cube, orig_cube)    
    #stays the same
    rotateSide_L_right(new_cube, orig_cube)
...
def rotateSide_D_front(new_cube, orig_cube):
    new_cube[0].insert(0, orig_cube [0][0])
    new_cube[0].insert(1, orig_cube [0][1])
    new_cube[0].insert(2, orig_cube [0][2])
    new_cube[0].insert(3, orig_cube [0][3])
...
def rotateSide_D_right(new_cube, orig_cube):
    new_cube[1].insert(0, orig_cube [1][0])
    new_cube[1].insert(1, orig_cube [1][1])
    new_cube[1].insert(2, orig_cube [1][2])
    new_cube[1].insert(3, orig_cube [1][3])
...
def rotateSide_D_back(new_cube, orig_cube):
    new_cube[2].insert(0, orig_cube [2][0])
    new_cube[2].insert(1, orig_cube [2][1])
    new_cube[2].insert(2, orig_cube [2][2])
    new_cube[2].insert(3, orig_cube [2][3])
...
def rotateSide_D_left(new_cube, orig_cube):
    new_cube[3].insert(0, orig_cube [3][0])
    new_cube[3].insert(1, orig_cube [3][1])
    new_cube[3].insert(2, orig_cube [3][2])
    new_cube[3].insert(3, orig_cube [3][3])
...
def rotateSide_D_top(new_cube, orig_cube):
    new_cube[4].insert(0, orig_cube [4][0])
    new_cube[4].insert(1, orig_cube [4][1])
    new_cube[4].insert(2, orig_cube [4][2])
    new_cube[4].insert(3, orig_cube [4][3])
...
def rotateSide_D_bottom(new_cube, orig_cube):
...
def rotateSide_D(orig_cube):
    new_cube = [[], [], [], [], [], []]
    rotateSide_D_front(new_cube, orig_cube)
    rotateSide_D_right(new_cube, orig_cube)   
    rotateSide_D_back(new_cube, orig_cube)
    rotateSide_D_left(new_cube, orig_cube)
    rotateSide_D_top(new_cube, orig_cube)   
    rotateSide_D_bottom(new_cube, orig_cube) 
